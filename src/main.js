...
ipcMain.handle('get-build-info', () => {
    ...
    return { version: '1.4.2 (v36)', buildTime: '未知', author: 'mywwzh' };
});
...
function updateSettings(settingsType, newSettings) {
    try {
        ...
        const validKeys = [
            'compilerPath', 'pythonInterpreterPath', 'compilerArgs', 'runMode', 'testlibPath', 'font', 'fontSize', 'terminalFontSize', 'lineHeight', 'theme',
...
function getResettableSettingsKeys() {
    return [
        ...
        'font', 'fontSize', 'terminalFontSize', 'lineHeight', 'theme', 'syntaxColorsByTheme', 'syntaxFontStyles', 'syntaxColors',
...
function importSettings(filePath) {
    try {
        ...
        const validKeys = ['compilerPath', 'compilerArgs', 'testlibPath', 'font', 'fontSize', 'terminalFontSize', 'lineHeight', 'theme', 'syntaxColorsByTheme', 'syntaxFontStyles', 'syntaxColors', 'tabSize', 'fontLigaturesEnabled', 'enableAutoCompletion', 'foldingEnabled', 'stickyScrollEnabled', 'autoSave', 'autoSaveInterval', 'autoBackupSettings', 'cppTemplate', 'codeSnippets', 'windowOpacity', 'glassEffectEnabled', 'backgroundImage', 'keybindings'];
        const defaultSettings = getDefaultSettings();
